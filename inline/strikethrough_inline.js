...
export class StrikethroughInline {
  static get isInline() {
    return true;
  }
  ...
  checkState() {
    const mark = this._api.selection.findParentTag(StrikethroughInline.TAG);
    this.state = !!mark;
  }

  static get sanitize() {
    return {
      [StrikethroughInline.TAG]: {},
    };
  }
}
